...
FIELD_STYLE = """
    ...
    QLineEdit:focus { border-color: #1a7fe8; }
"""
...
BTN_PRIMARY = """
    ...
    QPushButton:hover { background-color: #1a7fe8; }
"""
...
COMBO_STYLE = """
    ...
    QComboBox:hover { border-color: #1a7fe8; }
    QComboBox::drop-down {
...
LABEL_STYLE = "font-size: 13px; font-weight: 600; color: #333;"
...
class AskDBName(QWidget):
    ...
    def __init__(self):
        ...
        self.db_input.setStyleSheet(FIELD_STYLE)
...
class StartupAuth(QWidget):
    ...
    def __init__(self, db_name):
        ...
        self.otp_input.setStyleSheet(FIELD_STYLE)
...
class SignupForm(QWidget):
    ...
    def __init__(self, db_name):
        ...
        self.master.setStyleSheet(FIELD_STYLE)

        grid.addWidget(make_label("Username"),   0, 0)
        grid.addWidget(self.username,             0, 1)
        grid.addWidget(make_label("Password"),   1, 0)
        grid.addWidget(self.password,             1, 1)
        grid.addWidget(make_label("Setup Code"), 2, 0)
...
class LoginForm(QWidget):
    ...
    def __init__(self, db_name):
        ...
        self.username.setMinimumHeight(34)
        self.username.setStyleSheet(COMBO_STYLE)
        self.load_usernames()
        ...
        btn_signup.setStyleSheet(BTN_SECONDARY)
        ...
        db_label = QLabel(f"DB: {self.db_name}")
        db_label.setAlignment(Qt.AlignCenter)
        db_label.setStyleSheet("font-size: 10px; color: #bbb;")
...
class Dashboard(QWidget):
    ...
    def __init__(self, db_name, username="User"):
        ...
        db_info = QLabel(f"Database: {db_name}")
        db_info.setAlignment(Qt.AlignCenter)
        db_info.setStyleSheet("font-size: 11px; color: #aaa; background: transparent;")
        card_layout.addWidget(db_info)
